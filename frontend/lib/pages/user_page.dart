...
class _UserPageState
  ...
  Future<void> eliminarCuenta() async {
    ...
    final url = Uri.parse(
      'http://10.0.2.2:8080/api/auth/borrar/$username',
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Añadimos un botón de Salir (Logout) en la barra superior también
        title: Text(
          isAdmin
